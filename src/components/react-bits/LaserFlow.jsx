...
export default function LaserFlow({
    ...
    useEffect(() => {
        ...
        const renderer = new THREE.WebGLRenderer({
            antialias: false,
            alpha: true, // Use alpha so background shows through if needed, though shader is opaque mostly
            depth: false,
            stencil: false,
        ...
        // renderer.setClearColor(0x000000, 1); // Let CSS handle BG
        ...
        const material = new THREE.RawShaderMaterial({
            ...
            depthTest: false,
            depthWrite: false,
            blending: THREE.AdditiveBlending // Additive blending for laser effect
        });
