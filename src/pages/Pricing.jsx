...
const Pricing = () => {
    return (
        <>
            <SEOHead
                title="Pricing - Transparent Event Ticketing Fees"
                description="Tickify pricing plans for event organizers. Start free, pay only when you sell. Low transaction fees, no hidden costs. Compare Starter, Pro, and Custom enterprise plans."
                keywords={[
                    'tickify pricing',
                    'event ticketing fees',
                    'organizer costs',
                    'ticketing platform pricing',
                    'event platform fees india',
                    'free event hosting',
                    'ticket selling fees'
                ]}
                canonical="https://tickify.com/pricing"
                breadcrumbs={[
                    { name: 'Home', url: '/' },
                    { name: 'Pricing' }
                ]}
